...
public class BalancedParens {
	...
	public static void main(String[] args) {
		...
		String example2 = "))((";
		String example3 = "()()";
		System.out.println(BalancedParens.isBalanced(example1)); // should be true
		System.out.println(BalancedParens.isBalanced(example2)); // should be false
		System.out.println(BalancedParens.isBalanced(example3)); // should be true
}
}
